...
let populationLeft = population / 2 / 2;
console.log(populationLeft);
populationLeft++;
console.log(populationLeft + 1);
...
//   console.log("Finland's population is greater");
// }
...
if (avgPopulation > population) {
  console.log(
    `${country}'s population is less than the Average Country's Population by (${
      avgPopulation - population
    })`
  );
} else {
  console.log(
    `${country}'s population is above than the Average Country's Population `
  );
}
...
console.log("9" - "5"); // 4
console.log("19" - "13" + "17"); // 617{+ is what concatenates}
console.log("19" - "13" + 17); //23 {minus functions normally}
...
if (language === "English" && population < 50000000 && isIsland === false) {
  ...
  console.log(
    `Sarah can't live in ${country} because it doesn't meet your criteria`
  );
}
...
let languageSpeakers = "chinese";
switch (languageSpeakers) {
  case "chinese":
  case "mandarin":
...
console.log(value); // try not to be repeating
