...
const descNigeria = describeCountry("Nigeria", 7, "Abuja");
const descFinland = describeCountry("Finland", 2, "Helsinki");
const descSpain = describeCountry("Spain", 10, "Ecuador"); // you return functions
...
const percentNigeria1 = percentageOfWorld1(1441);
const percentChina1 = percentageOfWorld1(1247);
const percentSpain1 = percentageOfWorld1(1634);

console.log(percentNigeria1, percentChina1, percentSpain1);

const percentageOfWorld2 = function (population) {
  return (population / worldPopulation) * 100;
};
console.log("percentageOfWorld2");
const percentNigeria2 = percentageOfWorld2(1224);
const percentChina2 = percentageOfWorld2(3000);
const percentSpain2 = percentageOfWorld2(186);

console.log(percentNigeria2, percentChina2, percentSpain2);
...
const percentNigeria3 = percentageOfWorld3(1524);
const percentChina3 = percentageOfWorld3(1500);
const percentSpain3 = percentageOfWorld3(1846);

console.log(percentNigeria3, percentChina3, percentSpain3);
...
const describeNigeria = describePopulation("Nigeria", 1444);
const describeFinland = describePopulation("Finland", 2005);
const describeSpain = describePopulation("Spain", 1980);
...
let populations = [1200, 1498, 1972, 1400];
...
const neighbors = ["Nigeria", "Ghana", "Tanzania"];
...
neighbors[neighbors.indexOf("Tanzania")] = "Sweden";
console.log(neighbors);
...
let myCountry = {
  ...
  language: "Yoruba",
  population: 2300,
  neighbors: ["Sweden", "Ghana", "Tanzania"],
};
...
myCountry = {
  ...
  checkIsland: function () {
    ...
    return (this.isIsland = !Boolean(this.neighbors.length));
  },
};
console.log(myCountry.describe()); // call the method with the object name
...
populations = [1200, 1498, 1972, 1400];
let percentages2 = [];
